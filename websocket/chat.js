...
var rooms = [
  {id: 'hall', name: '大厅'},
  {id: 'room_1', name: '房间001'},
  {id: 'room_2', name: '房间002'}
];
...
function joinRoom (socket, room) {
  ...
  socket.emit('joinResult', {id: room, name: roomMapping[room]});
...
module.exports.listen = function (app, memoryStore) {
  ...
  chatIO.use(function (socket, next) {
    ...
    var unsignedCookies = require('cookie-signature').unsign(cookie['connect.sid'].slice(2), require('../app_server/config').sessionSecret);
